const SearchLocation = () => {
  return (
    <article className="flex items-center gap-1 mr-auto lg:border-l lg:pl-5 lg:pr-2 lg:ml-3 cursor-pointer">
      <svg
        width="20"
        height="20"
        viewBox="0 0 16 17"
      ...
      <span className="text-lg whitespace-nowrap font-medium text-[#6b4449] mt-1">
        Setup your precise location
      </span>
      <svg width="12" height="100%" viewBox="0 0 24 25" fill="#F15700">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
