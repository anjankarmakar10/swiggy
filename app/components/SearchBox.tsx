const SearchBox = () => {
  return (
    <article className="group h-10 lg:h-14 p-4 w-full lg:max-w-[496px] bg-[#f0f0f5] focus-within:bg-white focus-within:rounded-2xl rounded-[12px] focus-within:shadow-input flex items-center gap-3 ">
